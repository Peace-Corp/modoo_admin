...
import { Package, Settings, Users, BarChart3, Menu, X, ShoppingBag, MessageSquare, Factory } from 'lucide-react';
...
const allowedRoutesByRole: Record<AdminRole, string[]> = {
  admin: ['/products', '/content', '/orders', '/factories', '/cobuy', '/users', '/settings'],
  factory: ['/orders'],
};
