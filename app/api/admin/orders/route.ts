...
export async function GET(request: Request) {
  try {
    ...
    const selectFields = isFactoryUser
      ? `id, order_category, order_status, assigned_manufacturer_id, deadline, factory_amount, factory_payment_date, factory_payment_status, created_at, order_items(count)`
